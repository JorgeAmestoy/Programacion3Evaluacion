...
public class Calculadora extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        IPantalla = new javax.swing.JTextField();
        ...
        IPantalla.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        IPantalla.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                IPantallaActionPerformed(evt);
            }
        });

        bAC.setFont(new java.awt.Font("Liberation Sans", 0, 10)); // NOI18N
        ...
        bOFF.setFont(new java.awt.Font("Liberation Sans", 0, 10)); // NOI18N
        bOFF.setForeground(new java.awt.Color(0, 51, 255));
        bOFF.setText("OFF");
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                        .addGap(24, 24, 24)
                                        .addComponent(bOFF, javax.swing.GroupLayout.PREFERRED_SIZE, 56, javax.swing.GroupLayout.PREFERRED_SIZE))))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                .addComponent(b0)
                                .addGap(18, 18, 18)
                                .addComponent(bPunto)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(IPantalla, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(bAC, javax.swing.GroupLayout.DEFAULT_SIZE, 40, Short.MAX_VALUE)
    ...
    private void IPantallaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_IPantallaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_IPantallaActionPerformed

    private void b0ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b0ActionPerformed
        IPantalla.setText(IPantalla.getText()+"0");
    }//GEN-LAST:event_b0ActionPerformed

    private void b1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b1ActionPerformed
         IPantalla.setText(IPantalla.getText()+"1");
    }//GEN-LAST:event_b1ActionPerformed

    private void b2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b2ActionPerformed
         IPantalla.setText(IPantalla.getText()+"2");
    }//GEN-LAST:event_b2ActionPerformed

    private void b3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b3ActionPerformed
         IPantalla.setText(IPantalla.getText()+"3");
    }//GEN-LAST:event_b3ActionPerformed

    private void b4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b4ActionPerformed
         IPantalla.setText(IPantalla.getText()+"4");
    }//GEN-LAST:event_b4ActionPerformed

    private void b5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b5ActionPerformed
         IPantalla.setText(IPantalla.getText()+"5");
    }//GEN-LAST:event_b5ActionPerformed

    private void b6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b6ActionPerformed
         IPantalla.setText(IPantalla.getText()+"6");
    }//GEN-LAST:event_b6ActionPerformed

    private void b7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b7ActionPerformed
        IPantalla.setText(IPantalla.getText()+"7");
    }//GEN-LAST:event_b7ActionPerformed

    private void b8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b8ActionPerformed
         IPantalla.setText(IPantalla.getText()+"8");
    }//GEN-LAST:event_b8ActionPerformed

    private void b9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b9ActionPerformed
         IPantalla.setText(IPantalla.getText()+"9");
    ...
    private void bIgualActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bIgualActionPerformed
        num2 = Integer.parseInt(IPantalla.getText());
        
        switch (signo){
            case "+":
                IPantalla.setText(Integer.toString(num1+num2));//pasamos de entero a string porque hay que hacer el setText y es string
                break;
            
            case "-":
                IPantalla.setText(Integer.toString(num1-num2));
                break;                
    ...
    private void bMasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bMasActionPerformed
        num1= Integer.parseInt(IPantalla.getText());
        signo = "+";        
        IPantalla.setText("");
    ...
    public static void main(String args[]) {
         ...
         * For details see http://download.oracle.com/javase/tutorial/uiswing/lookandfeel/plabOFF
         */
        try {
    ...
    private javax.swing.JTextField IPantalla;
